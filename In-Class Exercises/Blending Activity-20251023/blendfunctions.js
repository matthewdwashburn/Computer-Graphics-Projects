import { initShaders, vec4, flatten, perspective, lookAt, translate } from './helperfunctions.js';
"use strict";
...
window.onload = function init() {
    ...
    gl.blendFuncSeparate(gl.SRC_ALPHA, gl.ONE_MINUS_SRC_ALPHA, gl.ONE, //note that this will force the resulting fragment to have an alpha of 1
...
function render() {
    ...
    let mv = lookAt(new vec4(0, 0, 5, 1), new vec4(0, 0, 0, 1), new vec4(0, 1, 0, 0));
    let commonmv = mv; //so we can get back to this state later
